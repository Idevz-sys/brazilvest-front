...
$(window).on("load", function () {
  ...
  switch (body.attr("data-page")) {
    ...
    case "stats":
      ...
      var myBarChart = new Chart(mybarcartCofig);
    ...
    case "wallet":
      ...
      var areachart21 = document
        .getElementsByClassName("areachartsmall")[0]
        .getContext("2d");
      var areachart31 = document
        .getElementsByClassName("areachartsmall")[1]
        .getContext("2d");
      var areachart41 = document
        .getElementsByClassName("areachartsmall")[2]
        .getContext("2d");
